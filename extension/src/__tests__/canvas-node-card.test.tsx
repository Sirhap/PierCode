...
describe('CanvasNodeCard', () => {
  ...
  it('does NOT render the pointer shield when idle (iframe is interactive)', () => {
    render(
      <CanvasNodeCard node={node} focused={false} gesturing={false} draggable={false} onStartDrag={noop} onStartResize={noop} onResizeTo={noop} onMaximize={noop} onContentZoom={noop} onFocus={noop} onClose={noop} />,
    );
  ...
  it('renders the pointer shield only while a gesture is in progress', () => {
    render(
      <CanvasNodeCard node={node} focused={false} gesturing={true} draggable={false} onStartDrag={noop} onStartResize={noop} onResizeTo={noop} onMaximize={noop} onContentZoom={noop} onFocus={noop} onClose={noop} />,
    );
  ...
  it('close button fires onClose (not swallowed by the drag handle)', () => {
    ...
    render(
      <CanvasNodeCard node={node} focused={false} gesturing={false} draggable={true} onStartDrag={onStartDrag} onStartResize={noop} onResizeTo={noop} onMaximize={noop} onContentZoom={noop} onFocus={noop} onClose={onClose} />,
    );
